    ...
    <>
      {isLoading ? (
        ...
        <div className="min-h-screen p-5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 overflow-auto gap-5">
            {playlists.map((playlist) => (
              ...
              >
                ...
                >
                  {/* <a target="_blank" className='absolute bg-black rounded-3xl m-1 transition-transform duration-300 hover:brightness-125 opacity-0 group-hover:opacity-100 transition-opacity mb-3'>
